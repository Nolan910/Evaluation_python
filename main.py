...
#Test fictif du modèle sur des données 2022 (Seulement 2021 et 2022 présent dans le ficheir)
données_2022 = cinemas[cinemas['Entrées 2022']]
VExplicative_2022 = données_2022[['écrans', 'fauteuils', 'population_commune']]
VCible_2022 = données_2022[['Entrées 2022']]

VCible_pred_2022 = rl_model.predict(VExplicative_2022)

r2_2022 = r2_score(VCible_2022, VCible_pred_2022)
mae_2022 = mean_absolute_error(VCible_2022, VCible_pred_2022)

print(f"Comparaison des prédictions avec les valeurs réelles pour 2022 :")
print(f"Coefficient de détermination (R²) pour 2022 : {r2_2022:.4f}")
print(f"Erreur moyenne absolue (MAE) pour 2022 : {mae_2022:.4f}")

comparison_df = pd.DataFrame({'Réalité': VCible_2022, 'Prédiction': VCible_pred_2022})
